...
class WinRoot:
    ...
    def show_one_contact(self, event):
        ...
        if self.find_list != []: # Если список поиска не пустой.
            ...
            ContactCard('find_list ---> ' + ShareData.data_str, 'Показать') # Вызов класса ContactCard. 
            ...
            if len(data_str_alph) > 1: # Если длина строки больше 1, значит это не буква алфавита.
                ...
                ContactCard('data_list_all_alph ---> ' + ShareData.data_str, 'Показать') # Вызов класса ContactCard.
