from tkinter import * # Добавлен для тестирования.
...
class ContactCard:
    ...
    def frame_c_ws(self):
        ...
        self.btn_close_addcont = Button(self.frame_c, width=10, text='Закрыть', command=self.close_win_show)
    ...
    def appear_temp(self):
        ...
        self.canvas_jp.after(500, self.appear_temp)
    ...
    def open_file_foto(self):
        ...
        foto_path_open = filedialog.askopenfilename(title='Выбор фотографии',
                                                        filetypes=(('Все файлы изображений','*.jpg; *.png'),('Все файлы', '*.*')))
...
if __name__ == '__main__':
    ...
    if choice == '1':
        ContactCard(win_root, 'Показать')
    elif choice == '2': 
        ContactCard(win_root, 'Добавить')
